...
| MR-N | Khai thác kho `Tài liệu/` (đề thi thật) — ưu tiên Lớp 11 | **Cao**, khối lượng lớn | 🚧 Đang làm (2026-07-10) — xem chi tiết mục 3 bên dưới |
| MR-K | Public deploy | **Chờ người dùng có mặt** | ⏳ Tiếp tục sau MR-N — đã chuẩn bị xong Postgres + Vercel env vars, còn thiếu bước Deploy cuối |
