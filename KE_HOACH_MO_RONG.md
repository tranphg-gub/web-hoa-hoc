...
| MR-K | Public deploy | **Chờ người dùng có mặt** | ⏳ Tiếp tục sau MR-Y — đã chuẩn bị xong Postgres + Vercel env vars; điều kiện tiên quyết "rate-limit sang Postgres" đã xong ở MR-V, không còn gì chặn kỹ thuật |
