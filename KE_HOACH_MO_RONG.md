...
| Mã | Tên giai đoạn | Rủi ro/độ phức tạp |
|---|---|---|
| MR-A | Bảo mật tài khoản & hệ thống | Thấp |
| MR-B | Tải xuống tài liệu (export) | Thấp |
| MR-C | Đổi AI sang Gemini | Thấp-Trung bình (cần API key thật để test) |
| MR-D | Đăng ký tự do + khung học phí 99k/lớp (chỉ khung, chưa thanh toán thật) | Trung bình |
